...
class Context: NSObject {
    ...
    init(named: String, withColor clr: UIColor = UIColor.getContextColors().random(), andProjects projs: Set<Project>? = nil) {
        name = named
        projects = projs
        color = clr
    }
...
extension UIColor {
    ...
    static func getInterfaceColors() -> [UIColor]{
    ...
    static func getContextColors() -> [UIColor]{
