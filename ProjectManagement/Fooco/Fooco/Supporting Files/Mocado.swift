...
class Mocado {
	...
	private static func createContexts() -> [Context] {
		let context1 = Context(named: "Context One", color: UIColor.contextColors().random(), projects: nil, minProjectWorkingTime: nil, maximumWorkingHoursPerProject: 3.hours)
		
		let context2 = Context(named: "Context Two", color: UIColor.contextColors().random(), projects: nil, minProjectWorkingTime: 1.hour, maximumWorkingHoursPerProject: 3.hours)
    ...
    private static func populateProjects() -> [Project] {
        ...
        let proj1 = Project(named: "Project Test", startsAt: today, endsAt: Date().addingTimeInterval(21.days), withContext: contexts.random(), importance: 1, totalTimeEstimated: 30.hours)
        
        let proj2 = Project(named: "Test Two", startsAt: today, endsAt: Date().addingTimeInterval(30.days), withContext: contexts.random(), importance: 1, totalTimeEstimated: 40.hours)
