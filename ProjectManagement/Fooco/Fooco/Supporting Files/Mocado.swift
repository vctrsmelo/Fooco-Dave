...
class Mocado {
    ...
    private static func populateProjects() -> [Project] {
        ...
        let proj1 = Project(named: "Project Test", startsAt: today, endsAt: Date().addingTimeInterval(21.days), withContext: contexts.first!, importance: 3, totalTimeEstimated: 30.hours)
